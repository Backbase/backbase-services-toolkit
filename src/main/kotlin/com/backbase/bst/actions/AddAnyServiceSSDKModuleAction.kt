...
class AddAnyServiceSSDKModuleAction : DumbAwareAction() {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        val libraries =  hashMapOf(
            ...
            "boot-loader" to Library("boot-loader",listOf("com.backbase.buildingblocks.boot-loader", "com.backbase.buildingblocks.backbaseloader"),"A Spring boot application launcher that allows you to add dependencies  to the CLASSPATH of your service at runtime."),
            ...
            "service-sdk-starter-core" to Library("service-sdk-starter-core", listOf("com.backbase.buildingblocks.service-sdk-starter-core"),"A BOM with a minimal set of dependencies which can be used via  Maven dependency import. Use this when developing a generic service  that does not require the DBS dependencies that other starters provide."),
            ...
            "service-sdk-starter-test" to Library("service-sdk-starter-test",listOf("com.backbase.buildingblocks.service-sdk-starter-test"),"Provides support for testing service-api endpoints."),
