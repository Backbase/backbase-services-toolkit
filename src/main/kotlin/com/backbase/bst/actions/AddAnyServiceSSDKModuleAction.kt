...
class AddAnyServiceSSDKModuleAction : DumbAwareAction() {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        val libraries =  hashMapOf(
            ...
            "boot-loader" to Library("boot-loader",listOf("com.backbase.buildingblocks.backbase-loader-tool"),"A Spring boot application launcher that allows you to add dependencies  to the CLASSPATH of your service at runtime."),
